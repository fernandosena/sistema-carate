<?php $this->layout("_theme"); ?>
    ...
    <article class="home_featured">
        ...
        <div class="home_featured_app">
            <img src="<?= theme("/assets/images/home-app.jpg"); ?>" alt="<?= CONF_SITE_NAME ?>" title="<?= CONF_SITE_NAME ?>"/>
        </div>
    </article>
    ...
    <article class="home_optin">
        <div class="home_optin_content container content">
            <header class="home_optin_content_flex">
                ...
                <p>Receber e pagar é uma tarefa comum do dia a dia, o <?= CONF_SITE_NAME ?> é um gerenciador de contas simples,
                    fácil
    ...
    <article class="home_video">
        <div class="home_video_content container content">
            <header>
                <h2>Descubra o <?= CONF_SITE_NAME ?></h2>
