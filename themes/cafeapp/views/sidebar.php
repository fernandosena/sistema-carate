<div class="app_sidebar_nav">
    ...
    <a class="icon-bookmark radius transition" title="Dashboard" href="<?= url("/app/documents"); ?>">Documentos</a>
    ...
    <a class="icon-bookmark-o radius transition" title="Certificado" href="<?= url("app/graduations"); ?>">Minhas graduações</a>
