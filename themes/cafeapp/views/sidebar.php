<div class="app_sidebar_nav">
    ...
    <a class="icon-user radius transition" title="Alunos Faixa Preta" href="<?= url("/app/alunos/black"); ?>">Alunos Faixa Preta</a>
    ...
    <?php if(user()->level == 5):?>
        <a class="icon-user radius transition" title="Sistema Admin" href="<?= url("/admin"); ?>">Admin</a>
    <?php endif; ?>
